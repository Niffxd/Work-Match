          ...
          <form>
            ...
            <div className={`${style["user-banner"]}`}>
              ...
              <div className={`${style["user-data"]}`}>
                ...
                <div
                  className={`${style["score-container"]} ${style["margin"]}`}
                >
                  {user.rate && (
                    <>
            ...
            <details className={`${style["questions-container"]}`}>
              ...
              <ul className={`${style["unordered-list"]}`}>
                <li>
                  Al publicar una nueva oferta de trabajo, esta se mostrará
                  entre las primeras búsquedas.
                </li>
                <li>
            ...
            <details className={`${style["questions-container"]}`}>
              ...
              <p>
                Al desactivar tu cuenta nadie podrá acceder a tus publicaciones
                ni a tu perfil.
              </p>
